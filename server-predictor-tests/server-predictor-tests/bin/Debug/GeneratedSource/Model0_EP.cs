...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>Message to marginal of 'vint6'</summary>
		public Discrete vint6_marginal_F;
		#endregion
		...
		{
			if (variableName=="vint6") {
				return this.Vint6Marginal();
			}
		...
		public void Constant()
		{
			...
			// The constant 'vDiscrete4'
			Discrete vDiscrete4 = Discrete.Uniform(2, Sparsity.FromSpec(MicrosoftResearch.Infer.Maths.StorageType.Dense, 0.0, 0));
			this.vint6_marginal_F = ArrayHelper.MakeUniform<Discrete>(vDiscrete4);
			this.Constant_iterationsDone = 1;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vint6' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public Discrete Vint6Marginal()
		{
			return this.vint6_marginal_F;
		}
