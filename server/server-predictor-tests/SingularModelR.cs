            ...
            int look_behind_prediction_self = 30, int look_behind_prediction = 10, int ahead = 10)
        {
            ...
            if (SingularModelR.engine == null)
            {
                try
                {
                    ...
                    var rBinPath = ServerCore.Instance.serverConfiguration.Rpath;
            ...
            try
            {
                ...
                SingularModelR.engine.Evaluate(m_predict_var_name + "= " + m_alg_name + ".getDefaultPredictOptionsAvgVelocity()");
                ...
                SingularModelR.engine.Evaluate(m_alg_name + ".loadGlobalGraph()");
                Logger.Instance.log("Load successful ");
                Logger.Instance.log("prepare depend lists");
